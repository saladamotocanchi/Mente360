...
const recommendations = {
  ...
  Hábitos:
    "Movimiento · Alimentación · Pequeños hábitos · Cuidado diario",
};
...
export default function MapaBienestar({
  onBack,
}) {
  const [
    testResult,
  ...
  return (
    ...
    >
      ...
      >
        Este mapa usa directamente
        los resultados guardados por
        el Test de bienestar. Es
        orientativo, no un diagnóstico.
      </p>
